    ...
    <div className="grid min-h-screen bg-paper lg:grid-cols-[1fr_1fr]">
      <div className="flex flex-col px-6 py-8 sm:px-10 lg:px-16 lg:py-12">
        ...
        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center py-12">
          ...
          <p className="mt-3 text-ink-600">Sign in to view today&apos;s report, messages, and billing.</p>
          ...
          <form action={login} className="mt-10 space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="inline-flex items-center gap-2 text-ink-600">
                <input name="rememberMe" type="checkbox" className="h-4 w-4 rounded border-line accent-ink" />
                Remember me
              </label>
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-sand via-paper to-sky/20 lg:block">
        ...
        <div className="absolute -right-16 bottom-12 h-48 w-48 rounded-full bg-coral/10" aria-hidden />
        <div className="absolute inset-0 flex flex-col justify-between p-16">
          <div className="flex justify-center pt-4">
            <div className="relative flex h-[360px] w-[360px] items-center justify-center rounded-full border border-sand/80 bg-surface/90 shadow-lift">
              ...
              <Image
                ...
                height={570}
                priority
                className="relative h-72 w-72 rounded-full bg-white object-contain p-2 drop-shadow-2xl"
              />
              <span className="absolute right-8 top-16 h-7 w-7 rounded-full bg-sunset shadow-soft" />
              <span className="absolute bottom-12 left-16 h-4 w-4 rounded-full bg-coral shadow-soft" />
            </div>
          </div>
          <div className="mx-auto max-w-xl rounded-3xl border border-sand/80 bg-surface/95 p-8 shadow-soft">
