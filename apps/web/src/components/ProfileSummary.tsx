...
export function ProfileSummary({ learner }: { learner: Learner }) {
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-line bg-cream p-4 sm:flex-row sm:items-center">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-lg font-bold text-deep">{learner.name}</p>
        <p className="text-sm text-muted">
          {learner.age} / {learner.classroom} class / Guardian: {learner.guardian}
        </p>
      </div>
